...
**Antes:**
- [ ] Completar `[comuna]` y **memorizar el guion** (no leerlo: se nota y baja la nota de dominio).
- [ ] Ensayar con cronómetro al menos 5 veces: todas las tomas deben salir entre 80 y 86 s. Si alguna pasa de 86, aplicar los cortes de emergencia — nunca acelerar la dicción para que quepa.
- [ ] **Construir antes el flujo mínimo real del asistente** (con la experiencia en automatización de WhatsApp son días, no meses): un número de prueba que confirma una cita de ejemplo y ofrece un cupo liberado. Mostrar ESA pantalla en el bloque de la solución — deja de ser utilería, es el producto — y queda lista para una eventual visita de verificación de Sercotec.

**Durante:**
- [ ] Luz de frente (ventana o aro de luz), fondo simple y ordenado.
- [ ] Audio limpio: pieza silenciosa, micrófono de solapa o audífonos con micrófono; **nada de música de fondo**.
- [ ] Cámara a la altura de los ojos; hablar a velocidad normal, con energía en el cierre.
- [ ] Vestimenta simple y profesional (el evaluador puede visitar/verificar después: coherencia).

**Después:**
- [ ] Ver el video completo con audífonos: ¿se entiende cada palabra? ¿dura ≤ 88 s?
- [ ] Exportar en HD según el formato que exija el anexo de las bases: **1280×720 si es horizontal o 720×1280 si es vertical**; verificar el peso máximo del archivo.
- [ ] Subirlo a la sección 6 del formulario y **reproducirlo desde la plataforma** para confirmar que quedó bien cargado.

## Por qué este guion gana puntos

- Cumple exactamente la estructura de la rúbrica (presentación → problema colectivo con datos → solución/diferenciador → cierre) con margen real de duración (≈ 4–8 s bajo el límite), en vez de apostar la mitad de la nota a hablar rápido.
- Las cifras son verificables y precisas ("en el sistema público", "horas de especialidad": la fuente es el 15,6% de la U. de Chile sobre consultas de especialidad) y coinciden con el formulario escrito — la consistencia entre pitch y Canvas suma en ambas partes.
- El diferenciador se dice en una frase que se recuerda ("los software mandan recordatorios; nosotros rellenamos la hora vacía").
- Menciona los dos segmentos del Canvas (centros privados del Gran Concepción y CESFAM) y cierra con **empleo y formalización** — el objetivo del programa que da nombre al fondo.
- Mostrar el asistente funcionando de verdad (no una maqueta) da la credibilidad de producto que la rúbrica premia en "dominio del tema".
